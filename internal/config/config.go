...
type Options struct {
	...
	DisableSystemWarnings     bool         `json:"disable_system_warnings,omitempty" jsonschema:"description=Disable Crush system advisories such as small-context-model and sysadmin warnings,default=false"`
}
