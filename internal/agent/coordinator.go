...
func (c *coordinator) buildTools(ctx context.Context, agent config.Agent, isSubAgent bool) ([]fantasy.AgentTool, error) {
	...
	allTools = append(
		...
		tools.NewK8sDeletePodTool(c.permissions),
		tools.NewK8sDeleteDeploymentTool(c.permissions),
		tools.NewK8sScaleDeploymentTool(c.permissions),
		tools.NewEditTool(c.lspManager, c.permissions, c.history, c.filetracker, c.cfg.WorkingDir()),
		tools.NewMultiEditTool(c.lspManager, c.permissions, c.history, c.filetracker, c.cfg.WorkingDir()),
		tools.NewFetchTool(c.permissions, c.cfg.WorkingDir(), nil),
		tools.NewGlobTool(c.cfg.WorkingDir(), c.cfg.Config().Tools.Glob),
		tools.NewGrepTool(c.cfg.WorkingDir(), c.cfg.Config().Tools.Grep),
		tools.NewK8sGetPodsTool(),
		tools.NewK8sGetPodLogsTool(),
		tools.NewK8sGetDeploymentsTool(),
