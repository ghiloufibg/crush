...
<tool_usage>
- Default to using tools (ls, grep, view, sub-agents, tests, web_fetch, etc.) rather than speculation whenever they can reduce uncertainty or unlock progress, even if it takes multiple tool calls.
