...
func executeBashCommand(ctx context.Context, params BashParams, execWorkingDir, spillDir string, blockFuncsToUse []shell.BlockFunc) (fantasy.ToolResponse, error) {
	...
	if params.RunInBackground {
		...
		bgShell, err := bgManager.Start(context.Background(), execWorkingDir, blockFuncsToUse, params.Command, params.Description)
		if err != nil {
